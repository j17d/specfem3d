...
SPECFEM3D Cartesian can handle finite fault sources of two kinds:
\begin{enumerate}
...
SPECFEM3D Cartesian (see next section). The Python language allows to define
...
a format compatible with SPECFEM3D Cartesian. This is achieved in the Python
...
at the very end of the script to export the mesh in a SPECFEM3D Cartesian format.
\end{enumerate}
