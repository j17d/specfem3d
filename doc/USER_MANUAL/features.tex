\chapter*{Simulation features supported in SPECFEM3D Cartesian}
\addcontentsline{toc}{chapter}{Simulation features supported in SPECFEM3D Cartesian}

The following lists all available features for a SPECFEM3D Cartesian simulation,
